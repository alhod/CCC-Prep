...
// nCr%p denotes the number of different ways to choose n items from a group of r items, where order doesn't matter.
// (i.e. (1, 2)==(2, 1)). This number can get very large, thus it is modulus p.
